...
const steps = [
  {
    Icon: Search,
    title: "Search first",
    body: "Many local businesses will already have a directory record. Checking first prevents duplicates.",
  },
  {
    Icon: BadgeCheck,
    title: "Prove the connection",
    body: "A Claim request requires evidence tying the requester to the business. Payment will not count as proof.",
  },
  {
    Icon: FileCheck2,
    title: "Review the facts",
    body: "Core contact and service details will be reviewed before publication or a material listing change.",
  },
];
      ...
      <section className="app-page px-4 py-10 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-3 font-display text-5xl font-semibold leading-[0.94] tracking-[-0.03em] sm:text-7xl">
            Put your Reno business on the map.
          </h1>
          ...
          {steps.map(({ Icon, title, body }, index) => (
            <section key={title} className="rounded-[24px] border border-line bg-card p-6">
              <div className="flex items-center justify-between">
                ...
                <span className="font-display text-xl text-muted">0{index + 1}</span>
              </div>
        ...
        <div className="mx-auto mt-8 flex max-w-3xl items-start gap-3 rounded-[22px] border border-gold/40 bg-card p-5">
          ...
          <div>
            <p className="font-semibold">Ownership and paid plans stay separate.</p>
            <p className="mt-1 text-sm leading-6 text-ink-soft">
              Claim approval is evidence-based. A free or paid plan will never establish business
              ownership, purchase a positive review, or change undisclosed organic rank.
            </p>
          </div>
        </div>
