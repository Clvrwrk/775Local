...
export const Route = createFileRoute("/categories/$slug")({
  ...
  head: ({ loaderData, params }) => ({ meta: loaderData ? [{ title: `${loaderData.category.name} in Northern Nevada | 775Directory` }, { name: "description", content: `Browse reviewed ${loaderData.category.name.toLowerCase()} listings in Reno and Sparks.` }] : [], links: [{ rel: "canonical", href: `https://775directory.com/categories/${params.slug}` }] }),
