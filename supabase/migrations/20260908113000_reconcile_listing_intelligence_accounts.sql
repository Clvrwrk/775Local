...
create function public.reconcile_listing_intelligence_accounts()
returns jsonb
language plpgsql
security definer
set search_path = ''
...
revoke all on function public.reconcile_listing_intelligence_accounts()
  from public, anon, authenticated;
grant execute on function public.reconcile_listing_intelligence_accounts()
  to service_role;
