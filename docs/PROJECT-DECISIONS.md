...
## 2026-08-24 — WorkOS and Supabase Preview activation attempt
...
- Correctly paired WorkOS Staging application credentials plus provider-level proof of the JWT claim template, login methods, session durations, Operations-organization MFA, and end-to-end authenticated-user flow are still required. CLE-106 remains in progress.
